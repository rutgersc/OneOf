...
namespace OneOf
{
    public readonly struct OneOf<T0, T1, T2, T3, T4, T5> : IOneOf
    {
		...
		public bool TryPickT0([NotNullWhen(true)]out T0? value, [NotNullWhen(false)]out OneOf<T1, T2, T3, T4, T5>? remainder)
	    {
		...
		public bool TryPickT1([NotNullWhen(true)]out T1? value, [NotNullWhen(false)]out OneOf<T0, T2, T3, T4, T5>? remainder)
	    {
		...
		public bool TryPickT2([NotNullWhen(true)]out T2? value, [NotNullWhen(false)]out OneOf<T0, T1, T3, T4, T5>? remainder)
	    {
		...
		public bool TryPickT3([NotNullWhen(true)]out T3? value, [NotNullWhen(false)]out OneOf<T0, T1, T2, T4, T5>? remainder)
	    {
		...
		public bool TryPickT4([NotNullWhen(true)]out T4? value, [NotNullWhen(false)]out OneOf<T0, T1, T2, T3, T5>? remainder)
	    {
		...
		public bool TryPickT5([NotNullWhen(true)]out T5? value, [NotNullWhen(false)]out OneOf<T0, T1, T2, T3, T4>? remainder)
	    {
